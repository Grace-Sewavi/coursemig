  ...
  return (
    <div className='bg-black min-w-full h-full text-white'>
        <div className='lg:flex flex lg:justify-evenly  justify-center text-md sm:text-md pt-28 '>
            <div className='lg:gap-x-3 gap-x-5'>
            ...
            <div>
                <ul>
                    <li className='font-sans lg:ml-0 ml-10 lg:mt-0 mt-10'>Features</li>
                    <li className='mt-5 lg:ml-0 ml-10 font-sans'>Courses</li>
                    <li className='mt-5 lg:ml-0 ml-10 font-sans'>Pricing</li>
                    <li className='mt-5 lg:ml-0 ml-10 font-sans'>Pricing</li>
                    <li className='mt-5 lg:ml-0 ml-10 font-sans lg:block hidden'>Blog</li>
                    <li className='mt-5 lg:ml-0 ml-10 font-sans lg:block hidden'>FAQs</li>
                </ul>
            </div>
        ...
        <div className='lg:flex justify-end gap-3 pt-20 mr-20 lg:block hidden'>
        ...
        <div className='flex ml-5 font-sans pb-12 lg:mt-0 mt-16'>
            <img  className='h-6' src={copy} alt=''/> <span className='font-sans ml-1 lg:text-md text-md'>2024 Coursemigo Inc. All rights reserved.</span>
                 <div className='w-9/12 mt-4 lg:block hidden ml-3 h-0.5 bg-white'></div>
         </div>
    </div>
  )
}
