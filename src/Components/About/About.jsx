...
const About = () => {
  return (
    <>
      ...
      <p className='about md:text-2xl text-md font-normal px-2 text-center mt-5 leading-6 md:leading-10'>Coursemigo offers affordable, unlimited access to diverse <br/> courses through a subscription model, enabling users to explore <br/> various subjects, share resources with family, and enjoy flexible,<br/> high-quality online education.</p>
      </div>

      <div className=' testimonial w-full mt-20'>
          <div className='flex  md:items-start items-center md:flex-row flex-col gap-5 py-10 '>
            <img src={testA} alt="" className='md:w-1/3 w-3/4 h-80' />
            <img src={testB} alt="" className='md:w-1/3 w-3/4 h-80' />
            <img src={testC}alt="" className='md:w-1/3 w-3/4 h-80'/>
          </div>
      </div>
